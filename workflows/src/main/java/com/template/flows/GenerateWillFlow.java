...
public class GenerateWillFlow {
    ...
    public static class GenerateWillFlowInitiator extends FlowLogic<SignedTransaction>{
        ...
        public GenerateWillFlowInitiator(String willId, String willType, String willDetails, Party verifier) {
            this.willId = willId;
        ...
        public SignedTransaction call() throws FlowException {
            ...
            WillState outputState = new WillState(this.willId, this.willType, this.willDetails, getOurIdentity(), this.verifier);

            progresstracker.setCurrentStep(GENERATING_TRANSACTION);
            TransactionBuilder txbuilder = new TransactionBuilder(notary);
            txbuilder.addOutputState(outputState, WILL_CONTRACT_ID);
            txbuilder.addCommand(new WillContract.GenerateWill(), getOurIdentity().getOwningKey());
    ...
    public static class GenerateWillFlowResponder extends FlowLogic<SignedTransaction>{
        ...
        @Override
        public SignedTransaction call() throws FlowException {
               System.out.println("Will received for verification");
